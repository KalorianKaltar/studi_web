...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?TypeUtilisateur $id_type = null;
    ...
    public function setAdresseComplement(?string $adresse_complement): static
    {
    ...
    public function getIdType(): ?TypeUtilisateur
    {
        return $this->id_type;
    }

    public function setIdType(?TypeUtilisateur $id_type): static
    {
